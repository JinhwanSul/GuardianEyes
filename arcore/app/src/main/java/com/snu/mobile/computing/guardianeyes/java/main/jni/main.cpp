...
Java_com_snu_mobile_computing_guardianeyes_java_main_tracking_Process_initializeData(JNIEnv *env, jclass clazz) {
    detFrameData.clear();
    detTitle.clear();
}
...
extern "C"
JNIEXPORT void JNICALL
Java_com_snu_mobile_computing_guardianeyes_java_main_tracking_Process_setTitle(JNIEnv *env, jclass clazz, jstring title) {
    char* nativeStr;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_snu_mobile_computing_guardianeyes_java_main_tracking_Process_setBox(JNIEnv *env, jclass clazz, jfloat x, jfloat y, jfloat width, jfloat height) {
...
Java_com_snu_mobile_computing_guardianeyes_java_main_tracking_Process_getData(JNIEnv *env, jclass clazz, jint index) {
...
Java_com_snu_mobile_computing_guardianeyes_java_main_tracking_Process_getTrackingTitle(JNIEnv *env, jclass clazz, jint index) {
...
Java_com_snu_mobile_computing_guardianeyes_java_main_tracking_Process_Sort(JNIEnv *env, jclass clazz) {
    // count frame
    frame_count++;
